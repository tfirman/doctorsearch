export function docLookup (isName, inputString) {
  let promise = new Promise(function(resolve, reject) {
    ...
    let url = "";
    if(isName) {
      url = `https://api.betterdoctor.com/2016-03-01/doctors?name=`+inputString+`&location=45.52%2C-122.682%2C100&sort=distance-asc&skip=0&limit=10&user_key=`+process.env.exports.apiKey;
    } else {
      url = `https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=${inputString}&location=45.52%2C-122.682%2C100&sort=distance-asc&skip=0&limit=10&user_key=`+process.env.exports.apiKey;
    }
